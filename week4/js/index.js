const listOfVideos = [{
    video: '../assets/Mood.mp4'
},
{
    video: '../assets/Muscular.mp4'
},
{
    video: '../assets/Cognitive.mp4'
},
{
    video: '../assets/Speech.mp4'
},
{
    video: '../assets/Nasal.mp4'
},
{
    video: '../assets/Sleep.mp4'
},
]
...
const listOfItems = [
{
    title: 'Mood',
    link: '#',
thumbnail: 'assets/Mood.png',
},
{
    title: 'Muscular',
    link: '#',
    thumbnail: 'assets/Muscular.png',
},
{
    title: 'Cognitive',
    link: '#',
    thumbnail: 'assets/Cognitive.png',
},
{
    title: 'Speech',
    link: '#',
    thumbnail: 'assets/Speech.png',
},
{
    title: 'Nasal',
    link: '#',
    thumbnail: 'assets/Nasal.png',
},
{
    title: 'Sleep Deprived',
    link: '#',
    thumbnail: 'assets/Sleep.png',
}
];
...
setTimeout(()=>{
    ...
    body.style.background='radial-gradient(circle at center, var(--color-text-secondary) 0, var(--color-text-secondary) 0, var(--color-text-secondary))'
